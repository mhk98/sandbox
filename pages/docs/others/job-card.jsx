...
import { job1Markup, job2Markup } from 'markups/others/job-cards'; // -------- data -------- //
...
const JobCards = () => {
  return <DocLayout pageTitle="Job Cards" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Use our custom job card components to build any custom section or blocks">
      {
      /* ========== section 1 ========== */
    }
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="row gy-6">
              {data.jobList.slice(0, 2).map(item => <div className="col-lg-6" key={item.id}>
      ...
      <section id="snippet-2" className="wrapper py-16">
        ...
        <div className="card">
          <div className="card-body mb-n2">
            {dataTwo.designJobList.map(item => <JobPostCard2 {...item} key={item.id} />)}
          </div>
