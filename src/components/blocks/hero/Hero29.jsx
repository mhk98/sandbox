...
const Hero29 = () => {
  return <section className="wrapper image-wrapper bg-full bg-image bg-overlay bg-overlay-light-600" style={{
      ...
      <div className="container pt-16 pt-md-18 pb-9">
        <div className="row gx-0 gy-10 align-items-center text-center text-lg-start">
          <div className="col-lg-6 col-xxl-5 position-relative" data-cues="slideInDown" data-group="page-title" data-delay="700">
            <img data-cue="fadeIn" data-delay="3000" src="/img/svg/doodle1.svg" className="h-9 position-absolute d-none d-lg-block" style={{
            top: '-9%',
            left: '-6%'
          }} alt="" />

            <img data-cue="fadeIn" data-delay="3000" src="/img/svg/doodle2.svg" className="h-15 position-absolute d-none d-lg-block" style={{
            bottom: '9%',
            right: '-22%'
          }} alt="" />
            ...
            <div data-delay="1800" data-cues="slideInDown" data-group="page-title-buttons" className="d-flex justify-content-center justify-content-lg-start">
              <span>
