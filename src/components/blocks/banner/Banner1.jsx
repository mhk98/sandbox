...
const Banner1 = () => {
  return <section className="wrapper bg-soft-primary">
      <div className="container pt-10 pb-15 py-lg-17 py-xl-20 py-xxl-22 position-relative">
        <img alt="" src="/img/photos/devices2.png" srcSet="/img/photos/devices2@2x.png 2x" className="position-lg-absolute col-12 col-lg-12 mt-lg-n50p mb-3 mb-md-10 mb-lg-0" style={{
        top: '50%',
        left: '-23%'
      }} />
