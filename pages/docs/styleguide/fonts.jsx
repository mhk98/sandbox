...
import CodeHighlight from 'components/reuseable/CodeHighlight'; // -------- data -------- //
...
const Fonts = () => {
  ...
  return <DocLayout pageTitle="Fonts" quickAccssLinks={quickAccess} description="Use one of the existing font options or a custom font of your choice to change the overall font in Sandbox.">
      {
      /* ========== section 1 ========== */
    }
