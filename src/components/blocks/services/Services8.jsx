...
const Services8 = () => {
  return <div className="row gx-lg-8 gy-8 mt-5 mt-md-12 mt-lg-0 mb-15 align-items-center">
      ...
      <div className="col-lg-6">
        ...
        <div className="row gx-xl-10 gy-6">
          ...
          icon
              ...
              <ServiceCard3 title={title} description="Nulla vitae elit libero pharetra augue dapibus." Icon={<IconBox icon={icon} className="icon btn btn-circle btn-lg btn-soft-primary pe-none me-5" />} />
            </div>)}
        </div>
      </div>
    </div>;
