...
import CodeHighlight from 'components/reuseable/CodeHighlight'; // -------- markup -------- //

import { fontSizeMarkup, lineHeightMarkup, letterSpacingMarkup } from 'markups/styleguide/misc'; // -------- data -------- //
...
const Misc = () => {
  return <DocLayout pageTitle="Misc" quickAccssLinks={quickAccess} descriptionClass="lead px-xxl-12" headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Learn more about some miscellaneous styling features used in Sandbox.">
      {
      /* ========== section 1 ========== */
    }
        ...
        <div className="card">
          <div className="card-body">
            <p className="mb-0">
              ...
              <a href="https://getbootstrap.com/docs/5.2/utilities/spacing/" className="external" target="_blank" rel="noreferrer">
                Bootstrap spacing
              </a>{' '}
        ...
        <div className="card">
          <div className="card-body">
            <p className="mb-0">
              ...
              <a href="https://getbootstrap.com/docs/5.2/layout/gutters/" className="external" target="_blank" rel="noreferrer">
                Bootstrap docs
              </a>
            </p>
          </div>
