          ...
          <div className="col-md-6 col-lg-5 col-xl-4 mx-auto">
            <div className="newsletter-wrapper">
              <div id="mc_embed_signup2">
                <form action="" method="post" target="_blank" className="validate" id="mc-embedded-subscribe-form2" name="mc-embedded-subscribe-form">
                  <div id="mc_embed_signup_scroll2">
                    <div className="mc-field-group input-group form-floating">
                      <input type="email" name="EMAIL" id="mce-EMAIL2" autoComplete="off" placeholder="Email Address" className="required email form-control" />
