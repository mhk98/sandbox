...
const Documentation = () => {
  return <DocLayout pageTitle="Get Started" quickAccssLinks={quickAccess} description="Guide to get started with Sandbox Modern & Multipurpose Bootstrap 5 Template.">
      {
      /* ========== section 1 ========== */
    }
      <section id="snippet-1" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            ...
            <a href="mailto:support@ui-lib.com" className="btn btn-primary rounded-pill me-2" target="_blank" rel="noreferrer">
              Contact Support
            </a>

            <a href="http://support.ui-lib.com/" className="btn btn-soft-primary rounded-pill" target="_blank" rel="noreferrer">
