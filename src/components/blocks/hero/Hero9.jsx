            ...
            <div className="row">
              <div className="col-3 offset-1 offset-lg-0 col-lg-4 d-flex flex-column">
                <div className="ms-auto mt-auto" style={zoomInAnimate('300ms')}>
                  <img className="img-fluid rounded shadow-lg" src="/img/photos/sa20.jpg" srcSet="/img/photos/sa20@2x.jpg 2x" alt="demo" />
                </div>

                <div className="ms-auto mt-5 mb-10" style={zoomInAnimate('600ms')}>
                  <img className="img-fluid rounded shadow-lg" src="/img/photos/sa18.jpg" srcSet="/img/photos/sa18@2x.jpg 2x" alt="demo" />
                </div>
              </div>

              <div className="col-4 col-lg-5" style={zoomInAnimate('0ms')}>
                <div>
                  <img className="w-100 img-fluid rounded shadow-lg" src="/img/photos/sa16.jpg" srcSet="/img/photos/sa16@2x.jpg 2x" alt="demo" />
                </div>
              </div>

              <div className="col-3 d-flex flex-column">
                <div className="mt-auto" style={zoomInAnimate('300ms')}>
                  <img alt="demo" src="/img/photos/sa21.jpg" srcSet="/img/photos/sa21@2x.jpg 2x" className="img-fluid rounded shadow-lg" />
                </div>

                <div className="mt-5" style={zoomInAnimate('600ms')}>
                  <img alt="demo" src="/img/photos/sa19.jpg" srcSet="/img/photos/sa19@2x.jpg 2x" className="img-fluid rounded shadow-lg" />
                </div>

                <div className="mt-5 mb-10" style={zoomInAnimate('900ms')}>
                  <img alt="demo" src="/img/photos/sa17.jpg" srcSet="/img/photos/sa17@2x.jpg 2x" className="img-fluid rounded shadow-lg" />
                </div>
              </div>
            </div>
          </div>
