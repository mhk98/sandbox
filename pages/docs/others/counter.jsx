...
import { Counter1, Counter2, Counter3 } from 'components/reuseable/counter'; // -------- markups -------- //

import { counter1Markup, counter2Markup, counter3Markup } from 'markups/others/counters'; // -------- data -------- //
...
const Counters = () => {
  return <DocLayout pageTitle="Counters" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Use our custom counter components to build any custom facts section or blocks">
      {
      /* ========== section 1 ========== */
    }
        ...
        <div className="card overflow-hidden">
          <div className="card-body bg-dark mb-n2">
            <div className="row align-items-center counter-wrapper gy-4 text-center">
              {factList2.map(item => <Counter2 key={item.id} {...item} />)}
            </div>
          </div>
