...
const FAQ8 = () => {
  return <Fragment>
      <div className="position-relative">
        <img data-delay="1800" src="/img/svg/doodle7.svg" className="h-7 position-absolute d-none d-lg-block" style={{
        top: '-90%',
        right: '-3%'
      }} alt="" />

        <img data-delay="1800" src="/img/svg/doodle8.svg" className="h-14 position-absolute d-none d-lg-block" style={{
        top: '-20%',
        left: '-12%'
      }} alt="" />
      ...
      <div className="accordion-wrapper" id="accordion">
        <div className="row">
          ...
          return <div className="col-md-6" key={i}>
                {items.map(item => <Accordion key={item.no} type="shadow-lg" {...item} />)}
              </div>;
        })}
        </div>
      </div>
