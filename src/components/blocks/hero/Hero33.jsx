const Hero33 = () => {
  return <section className="section-frame mx-xxl-11 overflow-hidden">
      <div className="wrapper image-wrapper bg-image bg-cover bg-overlay bg-overlay-light-500" style={{
      backgroundImage: 'url(/img/photos/bg23.png)'
    }}>
        <div className="container py-16 py-md-18 text-center position-relative">
          <div className="position-absolute shape yellow d-none d-lg-block w-5" style={{
          top: '18%',
          left: '5%'
        }}>
          ...
          <div className="position-absolute shape leaf d-none d-lg-block w-10" style={{
          bottom: '30%',
          left: '2%'
        }}>
          ...
          <div className="position-absolute shape fuchsia d-none d-lg-block w-6" style={{
          top: '20%',
          right: '2%',
          ...
          <div className="position-absolute shape grape d-none d-lg-block w-6" style={{
          bottom: '28%',
          right: '5%'
        }}>
          ...
          <div className="row">
            <div className="col-lg-9 col-xxl-8 mx-auto">
              ...
              <p className="lead fs-24 px-md-10 px-lg-0 mx-lg-n10 mx-xl-0 mb-8">
                ...
                color: 'var(--bs-dribbble)'
              }}>
                  Dribbble
                </a>
                , my portfolio on{' '}
                <a href="#" className="hover" style={{
                color: 'var(--bs-behance)'
              }}>
                  Behance
                </a>
                .
