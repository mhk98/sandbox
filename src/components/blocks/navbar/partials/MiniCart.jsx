...
const MiniCart = () => {
  return <div className="offcanvas offcanvas-end bg-light" id="offcanvas-cart" data-bs-scroll="true">
          ...
          name
              ...
              <div className="d-flex flex-row">
                <figure className="rounded w-17">
                  <Link href="/products/1" passHref legacyBehavior>
                    <a>
                      <Image src={image} width={90} height={100} alt={name} style={{
                    width: '100%',
                    height: 'auto'
                  }} />
                    </a>
