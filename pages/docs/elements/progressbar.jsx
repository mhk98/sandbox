...
import CodeHighlight from 'components/reuseable/CodeHighlight'; // -------- hook -------- //

import useProgressbar from 'hooks/useProgressbar'; // -------- markups -------- //

import { lineMarkup, circleMarkup } from 'markups/elements/progressbar'; // -------- data -------- //
...
const Progressbar = () => {
  ...
  useProgressbar();
  return <DocLayout pageTitle="Progressbar" quickAccssLinks={quickAccess} descriptionClass="lead px-xxl-11" headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Examples and instructions on how to add colorful progressbars on your website.">
      {
      /* ========== section 1 ========== */
    }
