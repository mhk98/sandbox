              ...
              <div className="row gx-4 gx-md-9">
                <div className="col-6">
                  <figure className="mt-9">
                    <Link href="#">
                      <img className="shadow-lg rounded-top" src="/img/demos/d18-1.jpg" srcSet="/img/demos/d18-1@2x.jpg 2x" alt="" />
                    </Link>
                  </figure>
                </div>
                ...
                <div className="col-6">
                  <figure>
                    <Link href="#">
                      <img className="shadow-lg rounded-bottom" src="/img/demos/d18-2.jpg" srcSet="/img/demos/d18-2@2x.jpg 2x" alt="" />
                    </Link>
                  </figure>
                </div>
              </div>
