...
import { BlogCard1 } from 'components/reuseable/blog-cards'; // -------- carousel breakpoint obj -------- //
...
const Blog1 = () => {
  return <section className="wrapper bg-light angled upper-end">
      <div className="container py-14 py-md-16">
        ...
        <div className="swiper-container blog grid-view mb-10">
          <Carousel grabCursor navigation={false} breakpoints={carouselBreakpoints}>
            {blogList1.map(item => <BlogCard1 key={item.id} {...item} />)}
          </Carousel>
        </div>
      </div>
    </section>;
