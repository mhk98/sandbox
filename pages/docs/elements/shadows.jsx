...
`;
  return <DocLayout pageTitle="Shadows" descriptionClass="lead px-xxl-12" headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description={<>
          Add or remove shadows to elements with box-shadow utilities.{' '}
          <a href="https://getbootstrap.com/docs/5.2/utilities/shadows/" target="_blank" rel="noreferrer" className="hover more">
            Bootstrap docs
          </a>
        </>}>
      {
