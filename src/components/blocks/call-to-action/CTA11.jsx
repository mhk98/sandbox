      ...
      <div className="container pt-10 pt-lg-10 pt-md-13 pb-8 pb-md-10 text-center text-lg-start">
        <div className="row gx-0 gy-10">
          <div className="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 position-relative">
            <img src="/img/svg/doodle2.svg" className="h-15 position-absolute d-none d-lg-block" style={{
            bottom: '36%',
            right: '-25%'
          }} alt="" />

            <img data-delay="1800" src="/img/svg/doodle6.svg" className="h-14 position-absolute d-none d-lg-block" style={{
            top: '-20%',
            left: '-25%'
          }} alt="" />
