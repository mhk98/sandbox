...
const Demo5 = () => {
  return <Fragment>
      ...
      <header className="wrapper bg-soft-primary">
        <Navbar logoAlt="logo" button={<div className="d-flex align-items-center gap-3">
      ...
      <main className="content-wrapper">
        ...
        <section className="wrapper bg-light">
          <div className="container pb-14 pb-md-16 mb-lg-21 mb-xl-23">
            ...
            <Services6 bulletColor="red" colOne={<Tiles7 />} rowClassNames="mb-14 mb-md-18" title="We have considered our solutions to support every stage of growth." description="Etiam porta sem malesuada magna mollis euismod. Donec ullamcorper nulla non metus auctor
            ...
            <Services6 colOne={<Tiles8 />} bulletColor="green" rowClassNames="mb-14 mb-md-18" title="We make spending stress free so you have the perfect control." description="Etiam porta sem malesuada magna mollis euismod. Donec ullamcorper nulla non metus auctor
              fringilla. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus,
              tellus ac cursus commodo." />
            ...
            <Services6 colOne={<Tiles9 />} bulletColor="yellow" title="We bring solutions to manage your finance the way works best." description="Etiam porta sem malesuada magna mollis euismod. Donec ullamcorper nulla non metus auctor
              fringilla. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus,
              tellus ac cursus commodo." />
          </div>
        </section>
