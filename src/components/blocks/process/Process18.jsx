...
const Process18 = () => {
  return <div className="row gx-md-8 gx-xl-12 mt-10 mt-md-13">
      ...
      <div className="col-lg-8">
        <div className="row gy-8 gx-md-8 gx-xl-12">
          ...
          ...item
              ...
              <ServiceCard3 title={item.title} description={item.description} Icon={<Icon className="icon-svg-sm solid-duo text-purple-aqua mt-1 me-4" />} />
            </div>)}
        </div>
      </div>
    </div>;
