...
import { ServiceCard3, ServiceCard4, ServiceCard5 } from 'components/reuseable/service-cards'; // -------- markups -------- //

import { card1Markup, card2Markup, card3Markup, card4Markup, card5Markup, card6Markup } from 'markups/others/service-cards'; // -------- data -------- //
...
const ServiceCards = () => {
  return <DocLayout pageTitle="Service Cards" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Use our custom service card components to build any custom section or blocks">
      {
      /* ========== section 1 ========== */
    }
          ...
          <div className="card-body mb-n2">
            <div className="row">
              <div className="col-lg-6 offset-lg-3">
                <ServiceCard5 url="#" icon="uil-monitor" title="Web Design" description="Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida." />
              </div>
            </div>
          </div>
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="row gy-5 text-center">
              {serviceList2.slice(0, 2).map(item => <div className="col-lg-6" key={item.id}>
                  <div className="card">
                    <div className="card-body">
