      ...
      <div className="col-lg-7 offset-lg-1 pricing-wrapper">
        ...
        <div className="row gy-6 position-relative mt-5">
          <div className="col-md-6">
            ...
            <PricingCard3 api={100} projects={5} storage={200} monthlyPrice={19} yearlyPrice={199} planName="Premium Plan" activeYearly={activeYearly} />
          </div>

          <div className="col-md-6 popular">
            <PricingCard3 api={300} projects={20} storage={500} monthlyPrice={49} yearlyPrice={499} planName="Corporate Plan" activeYearly={activeYearly} />
          </div>
        </div>
      </div>
    </div>;
