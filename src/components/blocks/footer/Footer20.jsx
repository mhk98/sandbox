...
const Footer20 = () => {
  return <footer className="wrapper pattern-wrapper bg-image section-frame" style={bgImage}>
      <div className="container pb-13 pb-md-15">
        <div className="card image-wrapper bg-full bg-image bg-overlay mt-n50p mx-md-5 rounded-xl" style={{
