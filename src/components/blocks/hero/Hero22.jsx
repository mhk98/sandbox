...
const Hero22 = () => {
  return <section className="section-frame br-fix overflow-hidden">
      <div className="wrapper image-wrapper bg-cover bg-image bg-overlay bg-overlay-500" style={{
        ...
        <div className="container pt-18 pt-lg-21 pb-17 pb-lg-19 text-center">
          <div className="row">
            <div className="col-md-9 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
              ...
              <a data-glightbox href="/media/movie.mp4" className="btn btn-circle btn-white btn-play ripple mx-auto" style={zoomInAnimate('1500ms')}>
