...
const Demo33 = () => {
  ...
  useProgressbar(); // used for masionry layout
  ...
  return <Fragment>
      ...
      <header className="wrapper bg-soft-primary my-1">
        <Navbar button={<NextLink title="Contact Me" href="#" className="btn btn-sm btn-primary" />} navClassName="navbar navbar-expand-lg center-nav navbar-light navbar-bg-light" />
      </header>
