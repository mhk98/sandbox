...
const Demo11 = () => {
  return <Fragment>
      ...
      <header className="wrapper bg-soft-primary">
        <Navbar stickyBox={false} logoAlt="logo-light" navOtherClass="navbar-other ms-lg-4" navClassName="navbar navbar-expand-lg classic transparent position-absolute navbar-dark" button={<NextLink href="#" title="Free Trial" className="btn btn-sm btn-white rounded-pill" />} />
      </header>
