...
const Hero8 = () => {
  return <div className="card bg-soft-primary rounded-4 mt-2 mb-13 mb-md-17">
      <div className="card-body p-md-10 py-xl-11 px-xl-15">
        <div className="row gx-lg-8 gx-xl-0 gy-10 align-items-center">
          <div className="col-lg-6 order-lg-2 d-flex position-relative">
            <img alt="demo" src="/img/photos/co3.png" srcSet="/img/photos/co3@2x.png 2x" className="img-fluid ms-auto mx-auto me-lg-8" style={fadeInAnimate('0ms')} />

            <div style={animation({
            name: 'slideInRight',
            delay: '600ms'
          })}>
              <div className="card shadow-lg position-absolute" style={{
              bottom: '10%',
              right: '-3%'
            }}>
                <div className="card-body py-4 px-5">
                  <div className="d-flex flex-row align-items-center">
                    <div>
                      <IconBox icon="uil-users-alt" className="icon btn btn-circle btn-md btn-soft-primary pe-none mx-auto me-3" />
                    </div>
