...
import { Counter3 } from 'components/reuseable/counter'; // -------- data -------- //

import { factList8 } from 'data/facts';

const Facts15 = () => {
  return <div className="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0 mb-11">
      ...
      <div className="col-lg-8 mt-lg-2">
        <div className="row align-items-center counter-wrapper gy-6 text-center">
          ...
          icon,
          ...item
        }) => <Counter3 {...item} key={id} Icon={<IconBox className="icon btn btn-circle btn-lg btn-soft-primary pe-none mb-4" icon={icon} />} />)}
        </div>
      </div>
    </div>;
};
