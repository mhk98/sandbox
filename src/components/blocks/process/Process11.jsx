  ...
  return <Fragment>
      ...
      <div className="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-17 align-items-center">
        <div className="col-lg-6 position-relative">
          <div className="shape bg-dot leaf rellax w-17 h-18" style={{
          bottom: '-2rem',
          left: '-0.7rem'
        }} />
        ...
        <div className="col-lg-6 col-xxl-5">
          ...
          {processList.map(item => <ProcessList2 {...item} key={item.no} className="icon btn btn-circle btn-soft-primary pe-none me-5" />)}
        </div>
      </div>
    </Fragment>;
};
