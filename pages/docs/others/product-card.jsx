...
import { ProductCard, ProductCard2 } from 'components/reuseable/product-cards'; // -------- markups -------- //

import { card1Markup, card2Markup } from 'markups/others/product-cards'; // -------- data -------- //
...
const ProductCards = () => {
  return <DocLayout pageTitle="Product Cards" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Use our custom product card components to build any custom section or blocks">
      {
      /* ========== section 1 ========== */
    }
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="row gy-10">
              {products.slice(0, 2).map(item => <ProductCard {...item} key={item.id} className="col-lg-6" />)}
            </div>
          </div>
      ...
      <section id="snippet-2" className="wrapper py-16">
        ...
        <div className="card">
          <div className="card-body mb-n2">
            {orderProducts.slice(0, 2).map(item => <ProductCard2 {...item} key={item.id} />)}
          </div>
