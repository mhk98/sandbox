      ...
      <div className="container py-15 py-md-17">
        ...
        <div className="row gx-lg-0 gy-10 mb-15 mb-md-17 align-items-center">
          <div className="col-lg-6">
            <figure className="rounded mb-0">
              <img alt="" className="img-fluid" src="/img/illustrations/ui4.png" srcSet="/img/illustrations/ui4@2x.png 2x" />
            </figure>
          </div>
        ...
        <div className="row gx-lg-0 gy-10 mb-15 mb-md-17 align-items-center">
          <div className="col-lg-6 order-lg-2 ms-auto">
            <figure className="rounded mb-0">
              <img alt="" className="img-fluid" src="/img/illustrations/ui1.png" srcSet="/img/illustrations/ui1@2x.png 2x" />
            </figure>
          </div>
        ...
        <div className="row gx-lg-0 gy-10 align-items-center">
          <div className="col-lg-6">
            <figure className="rounded mb-0">
              <img alt="" className="img-fluid" src="/img/illustrations/ui5.png" srcSet="/img/illustrations/ui5@2x.png 2x" />
            </figure>
          </div>
...
const ColumnTwo = ({
  ...
  // list data
  const list = ['Aenean quam ornare curabitur blandit.', 'Nullam quis risus eget urna mollis ornare leo.', 'Etiam porta euismod mollis natoque ornare.'];
  return <div className={`col-lg-5 ${className}`}>
