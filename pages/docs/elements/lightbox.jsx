...
import CodeHighlight from 'components/reuseable/CodeHighlight'; // -------- custom hook -------- //

import useLightBox from 'hooks/useLightBox'; // -------- markups -------- //

import { imageMarkup, videoMarkup } from 'markups/elements/lightbox'; // -------- data -------- //
...
const Lightbox = () => {
  ...
  useLightBox();
  return <DocLayout pageTitle="Image Hover" quickAccssLinks={quickAccess} descriptionClass="lead px-xxl-12" headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Use our custom hover styles to add hover state to your images and elements.">
      {
      /* ========== section 1 ========== */
    }
        ...
        <div className="card">
          <div className="card-body">
            <div className="row gy-6">
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="overlay overlay-1 hover-scale rounded">
                  <a href="/img/photos/p3@2x.jpg" data-gallery="gallery-image" data-glightbox="title: Title; description: This is the image description">
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="overlay overlay-1 hover-scale rounded">
                  <a href="/img/photos/p2@2x.jpg" data-gallery="gallery-image" data-glightbox="title: Title; description: .caption-1">
        ...
        <div className="card">
          <div className="card-body">
            <div className="row gy-6">
              ...
              <div className="item col-md-6 col-lg-4">
                <figure className="overlay overlay-1 hover-scale rounded">
                  <a href="/media/movie.mp4" data-glightbox data-gallery="gallery-video" data-poster="/img/photos/movie.jpg">
                    <img src="/img/photos/p6.jpg" srcSet="/img/photos/p6@2x.jpg 2x" alt="" />
                    <span className="bg" />
                  </a>
                  <figcaption>
