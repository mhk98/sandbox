...
import CodeHighlight from 'components/reuseable/CodeHighlight'; // -------- icons -------- //

import Rocket from 'icons/lineal/Rocket';
import Savings from 'icons/lineal/Savings'; // -------- markups -------- //

import { basicMarkup, pillMarkup, justifiedMarkup } from 'markups/elements/tabs'; // -------- data -------- //
...
const Tabs = () => {
  return <DocLayout pageTitle="Tabs" quickAccssLinks={quickAccess} descriptionClass="lead px-xxl-15" description={<>
          Use our custom tabs to add tabbed interfaces on your website.{' '}
          <a href="https://getbootstrap.com/docs/5.2/components/navs-tabs/#javascript-behavior" target="_blank" rel="noreferrer" className="hover more">
            Bootstrap docs
          </a>
        </>}>
      {
