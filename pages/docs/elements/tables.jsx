...
import { simpleMarkup, stripedMarkup, borderedMarkup, hoverableMarkup, simpleDarkMarkup, borderlessMarkup, responsiveMarkup } from 'markups/elements/tables'; // -------- data -------- //
...
const Tables = () => {
  ...
  return <DocLayout pageTitle="Tables" quickAccssLinks={quickAccess} description={<>
          Some examples for displaying tables. For more detailed examples and guidelines please visit{' '}
          <a href="https://getbootstrap.com/docs/5.2/content/tables" target="_blank" rel="noreferrer" className="hover more">
            Bootstrap docs
          </a>
        </>}>
      {
