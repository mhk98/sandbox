...
const Services10 = () => {
  return <div className="row gx-lg-0 gy-10 mb-15 mb-md-18 align-items-center">
        ...
        <div className="row g-6 text-center">
          ...
          <div className="col-md-6">
            <div className="row">
              ...
              <div className="col-lg-12">
                <ServiceCard5 url="#" title="Mobile Design" icon="uil-mobile-android" className="card shadow-lg mb-md-6 mt-lg-6" description="Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida." />
              </div>
            </div>
          </div>
        </div>
