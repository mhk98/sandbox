                    ...
                    <div className="row gx-4">
                      <div className="col-md-6">
                        <div className="form-floating mb-4">
                          <input required type="text" name="name" id="form_name" placeholder="Name" className="form-control bg-white-700 border-0" />
                      ...
                      <div className="col-md-6">
                        <div className="form-floating mb-4">
                          <input required type="email" name="email" id="form_email" placeholder="jane.doe@example.com" className="form-control bg-white-700 border-0" />
                      ...
                      <div className="col-12">
                        <div className="form-floating mb-4">
                          <textarea required name="message" id="form_message" placeholder="Your message" className="form-control bg-white-700 border-0" style={{
                          height: 150
                        }} />
