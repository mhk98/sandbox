...
const list = ['Aenean eu leo quam pellentesque.', 'Nullam quis risus eget urna mollis.', 'Donec id elit non mi porta gravida.', 'Fusce dapibus tellus ac commodo.', 'Cras justo odio dapibus ac facilisis in.'];
      ...
      <div className="container pt-12 pt-md-14 pb-14 pb-md-16">
        ...
        <div className="row gx-md-8 gx-xl-12 gy-6 mt-8">
          ...
          <div className="col-lg-4">
            ...
            {processList.map(item => <ProcessList2 {...item} key={item.no} className="icon btn btn-circle btn-soft-primary pe-none mt-1 me-5" />)}
          </div>
        </div>
      </div>
    </section>;
