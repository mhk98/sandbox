...
const Testimonial27 = () => {
  return <section className="section-frame mx-xxl-11">
      <div className="wrapper image-wrapper bg-image bg-cover bg-overlay bg-overlay-light-500 section-frame-wrapper" style={{
