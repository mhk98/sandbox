...
import ThumbsCarousel from 'components/reuseable/ThumbsCarousel'; // -------- markups -------- //

import { simpleMarkup, cardMarkup, textMarkup, imageMarkup, thumbnailMarkup } from 'markups/elements/carousel'; // -------- data -------- //
...
const Carousel = () => {
  return <DocLayout pageTitle="Carousel" quickAccssLinks={quickAccess} descriptionClass="lead px-xxl-2" description={<>
        ...
        <div className="card">
          <div className="card-body">
            <SwiperCarousel breakpoints={carouselBreakpoints}>
              {['p1', 'p2', 'p3', 'p4', 'p5'].map(item => <figure className="overlay overlay-1 hover-scale rounded mb-0" key={item}>
                  <a href="#">
      ...
      <section id="snippet-2" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <SwiperCarousel grabCursor spaceBetween={0} slidesPerView={2} navigation={false} className="dots-closer blog grid-view" breakpoints={{
            768: {
              slidesPerView: 2
            },
            0: {
              ...
              {[1, 2, 3, 4].map(item => <div className="item-inner" key={item}>
                  <article>
                    <div className="card">
                      <div className="card-body">
                        <p>
      ...
      <section id="snippet-4" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <SwiperCarousel autoHeight spaceBetween={5} slidesPerView={1} className="dots-over" slideClassName="bg-overlay bg-overlay-400 rounded">
              <div>
