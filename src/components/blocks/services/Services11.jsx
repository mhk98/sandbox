...
const Services11 = () => {
  return <div className="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-20 align-items-center">
      <div className="col-md-8 col-lg-6 order-lg-2 position-relative">
        <div className="shape bg-soft-primary rounded-circle rellax w-20 h-20" style={{
        top: '-2rem',
        right: '-1.9rem'
      }} />
      ...
      <div className="col-lg-6">
        ...
        <div className="row gx-xl-10 gy-6">
          ...
          Icon
              ...
              <ServiceCard3 title={title} description={description} Icon={<Icon className="icon-svg-sm text-primary me-5" />} />
            </div>)}
        </div>
      </div>
    </div>;
