...
import { TeamCard1, TeamCard2, TeamCard3 } from 'components/reuseable/team-cards'; // -------- markups -------- //

import { card1Markup, card2Markup, card3Markup } from 'markups/others/team-cards'; // -------- data -------- //
...
const TeamCards = () => {
  return <DocLayout pageTitle="Team Cards" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Use our custom team card components to build any custom blog section or blocks">
      {
      /* ========== section 1 ========== */
    }
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="row gy-6 gy-lg-0">
              {teams.slice(0, 2).map(item => <div className="col-lg-6" key={item.id}>
                  <TeamCard1 {...item} />
                </div>)}
            </div>
          </div>
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="row gy-6 gx-lg-14">
              {teams.slice(0, 2).map(team => <div className="col-lg-6" key={team.id}>
                  <TeamCard2 {...team} />
                </div>)}
            </div>
          </div>
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="row gy-6 gx-lg-12">
              {teams2.slice(0, 2).map(item => <div className="col-md-6" key={item.id}>
                  <TeamCard3 {...item} />
                </div>)}
            </div>
          </div>
