...
import { cookieMarkup, subscriptionMarkup, signinMarkup, signupMarkup } from 'markups/elements/modal'; // -------- data -------- //
...
const Modal = () => {
  return <DocLayout pageTitle="Modal" quickAccssLinks={quickAccess} descriptionClass="lead px-xxl-10" headingColClass="col-md-9 col-lg-7 col-xl-7 mx-auto" description={<>
          Use Bootstrap’s modal plugin with our custom styles to add dialogs to your site for notifications or
          completely custom content.{' '}
          <a href="https://getbootstrap.com/docs/5.2/components/modal/" target="_blank" rel="noreferrer" className="hover more">
            Bootstrap docs
          </a>
        </>}>
      {
      ...
      <section id="snippet-1" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <button data-bs-toggle="modal" data-bs-target="#modal-01" className="btn btn-primary rounded-pill mx-1 mb-2 mb-md-0">
              Cookie
            </button>
      ...
      <section id="snippet-2" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <button data-bs-toggle="modal" data-bs-target="#modal-02" className="btn btn-primary rounded-pill mx-1 mb-2 mb-md-0">
              Subscription
            </button>
                      ...
                      <div className="row">
                        <div className="col-md-10 offset-md-1">
                          <div id="mc_embed_signup">
                            <form action="https://elemisfreebies.us20.list-manage.com/subscribe/post?u=aa4947f70a475ce162057838d&amp;id=b49ef47a9a" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank">
                              <div id="mc_embed_signup_scroll">
                                <div className="mc-field-group input-group form-floating">
                                  <input type="email" name="EMAIL" className="required email form-control" placeholder="Email Address" id="mce-EMAIL" />
      ...
      <section id="snippet-3" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <button className="btn btn-primary rounded-pill mx-1 mb-2 mb-md-0" data-bs-toggle="modal" data-bs-target="#modal-signin">
              Sign In
            </button>
      ...
      <section id="snippet-4" className="wrapper py-16">
        ...
        <div className="card">
          <div className="card-body">
            <button className="btn btn-primary rounded-pill mx-1 mb-2 mb-md-0" data-bs-toggle="modal" data-bs-target="#modal-signup">
              Sign Up
            </button>
