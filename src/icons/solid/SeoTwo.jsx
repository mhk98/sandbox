const SeoTwo = ({
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className={`svg-inject icon-svg ${className || 'solid-duo text-grape-fuchsia'}`}>
      ...
      <path className="fill-secondary" d="M157.33 202.67H98.66A29.35 29.35 0 0069.33 232v16a8 8 0 008 8h101.33a8 8 0 008-8v-16a29.35 29.35 0 00-29.33-29.33z" />
    </svg>;
};
