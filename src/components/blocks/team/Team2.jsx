...
import { TeamCard2 } from 'components/reuseable/team-cards'; // -------- data -------- //

import teams from 'data/team-list';

const Team2 = () => {
  return <div className="row gx-lg-8 gx-xl-12 gy-10 mb-16 mb-md-17 mb-xl-20 align-items-center">
      ...
      <div className="col-lg-8">
        <div className="swiper-container text-center mb-6">
          <Carousel grabCursor navigation={false} breakpoints={carouselBreakpoints}>
            {teams.map(team => <TeamCard2 key={team.id} {...team} />)}
          </Carousel>
        </div>
      </div>
    </div>;
