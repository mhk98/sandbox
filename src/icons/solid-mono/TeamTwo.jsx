const TeamTwo = ({
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 255.98 256" className={`svg-inject icon-svg solid-mono ${className || 'icon-svg-sm text-violet mb-3'}`}>
