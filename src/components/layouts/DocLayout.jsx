...
import useClipboard from 'hooks/useClipboard'; // -------- data -------- //
...
const DocLayout = ({
  ...
  const {
    pathname
  } = useRouter(); // render the links

  const renderLinks = data => {
    return data.map(item => <li key={item.title}>
      ...
      <div className="content-wrapper">
        ...
        <div className="container">
          <div className="row">
            ...
            {quickAccssLinks && <aside className="col-xl-2 order-xl-3 sidebar sticky-sidebar mt-md-0 py-16 d-none d-xl-block">
                <div className="widget">
                  ...
                  <nav className="ps-xl-5" id="sidebar-nav">
                    <ul className="list-unstyled fs-sm lh-sm text-reset">
                      {quickAccssLinks.map((item, i) => <li key={i}>
