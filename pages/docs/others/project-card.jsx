...
import { ProjectCard1, ProjectCard2, ProjectCard3 } from 'components/reuseable/project-cards'; // -------- markups -------- //

import { card1Markup, card2Markup, card3Markup } from 'markups/others/project-cards'; // -------- hooks -------- //
...
const ProductCards = () => {
  useIsotope();
  useLightBox();
  return <DocLayout pageTitle="Project Cards" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Use our custom project card components to build any custom section or blocks">
      {
      /* ========== section 1 ========== */
    }
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="projects-tiles">
              {projectList.map(item => <ProjectCard1 {...item} key={item.id} />)}
            </div>
          </div>
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="projects-overflow">
              {projectList2.map(item => <ProjectCard2 {...item} key={item.id} />)}
            </div>
          </div>
          ...
          <div className="card-body mb-n2">
            <div className="grid grid-view projects-masonry">
              <div className="row gx-md-8 gy-10 gy-md-13 isotope">
                {projectList3.map(item => <div className="project item col-lg-6" key={item.id}>
                    <ProjectCard3 {...item} />
                  </div>)}
              </div>
            </div>
