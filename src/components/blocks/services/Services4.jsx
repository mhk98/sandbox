...
import { ServiceCard2 } from 'components/reuseable/service-cards'; // -------- data -------- //
...
const Services4 = () => {
  return <Fragment>
      ...
      <div className="row gx-md-8 gy-8 mb-14 mb-md-18">
        {serviceList3.map(item => <ServiceCard2 {...item} key={item.id} iconBoxClassNames="icon btn btn-block btn-lg btn-soft-primary pe-none mb-6" />)}
      </div>
    </Fragment>;
};
