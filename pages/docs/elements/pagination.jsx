...
import { defaultMarkup, alternativeMarkup, breadcrumbMarkup } from 'markups/elements/pagination'; // -------- data -------- //
...
const PaginationDoc = () => {
  return <DocLayout pageTitle="Pagination" quickAccssLinks={quickAccess} descriptionClass="lead px-xxl-3" headingColClass="col-md-9 col-lg-7 col-xl-7 mx-auto" description="Use our pagination and breadcrumb examples to show that a series of related content exists across multiple pages and navigational hierarchy.">
      {
      /* ========== section 1 ========== */
    }
      ...
      <section id="snippet-3" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            ...
            <Breadcrumb className="mb-0" data={[{
            id: 1,
            title: 'Home',
            url: '#'
          }, {
