...
const Demo30 = () => {
  return <div className="bg-soft-primary pb-md-6">
      <PageProgress />
      ...
      <header className="position-absolute w-100">
        ...
        <div className="gradient-5 text-white fw-bold fs-15 mb-2 position-relative" style={{
        zIndex: 1
      }}>
      ...
      <main className="content-wrapper">
        ...
        <section className="wrapper pattern-wrapper bg-image section-frame" style={{
