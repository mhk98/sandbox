import { zoomInAnimate } from 'utils/animation'; // -------- custom hook -------- //
      ...
      <div className="container pt-17 pb-19 pt-md-19 pb-md-20 text-center">
        <div className="row mb-11">
          <div className="col-md-9 col-lg-7 col-xxl-6 mx-auto">
            ...
            <a data-glightbox href="/media/movie.mp4" className="btn btn-circle btn-white btn-play ripple mx-auto mb-5" style={zoomInAnimate('1000ms')}>
