...
import { darkMarkup, paleMarkup, softMarkup, videoMarkup, colorMarkup, patternMarkup, gradientMarkup, imageBackgroundMarkup } from 'markups/elements/background'; // -------- data -------- //
...
const Background = () => {
  return <DocLayout pageTitle="Background" quickAccssLinks={quickAccess} description="Use our custom background styles to add image, color, pattern or video backgrounds to your sections.">
      {
      /* ========== section 1 ========== */
    }
      ...
      <section id="snippet-6" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <section className="wrapper pattern-wrapper bg-image text-white" style={{
