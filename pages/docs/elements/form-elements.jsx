...
import { inputMarkup, checkMarkup, radioMarkup, selectMarkup, disabledMarkup, textareaMarkup } from 'markups/elements/from-elements'; // -------- data -------- //
...
const FormElements = () => {
  return <DocLayout pageTitle="Form Elements" quickAccssLinks={quickAccess} description={<>
          Some examples for form control styles. For more detailed examples and guidelines please visit
          <a href="https://getbootstrap.com/docs/5.2/forms/overview/" className="hover more" rel="noreferrer" target="_blank">
            Bootstrap docs
          </a>
        </>}>
      {
      ...
      <section id="snippet-2" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <div className="form-floating">
              <textarea required id="textareaExample" placeholder="Textarea" className="form-control" style={{
              height: 150
            }} />
