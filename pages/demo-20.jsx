...
const Demo20 = () => {
  // lighbox hook called
  useLightBox();
  return <div className="page-frame bg-pale-primary">
      <PageProgress />
      ...
      <header className="wrapper">
        <Navbar info language stickyBox={false} logoAlt="logo-light" navClassName="navbar navbar-expand-lg classic transparent position-absolute navbar-dark" />
      </header>
