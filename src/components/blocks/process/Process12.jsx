...
const Process12 = () => {
  return <div className="row gx-md-8 gx-xl-12 gy-10 align-items-center">
      ...
      <div className="col-lg-6">
        ...
        subtitle,
        color
      }) => <ServiceCard3 key={no} title={title} description={subtitle} className={'d-flex flex-row ' + className} Icon={<span className={`icon btn btn-block btn-lg btn-soft-${color} pe-none mt-1 me-5`}>
