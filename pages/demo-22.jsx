...
const Demo22 = () => {
  // lighbox hook called
  useLightBox(); // used for the animated line

  useProgressbar();
  return <div className="py-md-6">
      <PageProgress />
      ...
      <header className="wrapper">
        <Navbar info search stickyBox={false} logoAlt="logo-light" navClassName="navbar navbar-expand-lg center-nav transparent position-absolute navbar-dark px-md-10 px-xxl-0" />
      </header>
