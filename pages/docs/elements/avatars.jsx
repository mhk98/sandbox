...
import { lettersMarkup, imagesMarkup } from 'markups/elements/avatars'; // -------- data -------- //
...
const Avatars = () => {
  return <DocLayout pageTitle="Avatars" quickAccssLinks={quickAccess} description="Use our custom avatar styles on your profile images or initials.">
      {
      /* ========== section 1 ========== */
    }
