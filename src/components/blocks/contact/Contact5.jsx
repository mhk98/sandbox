...
const Contact5 = () => {
  return <div className="row gy-10 gx-lg-8 gx-xl-12 mb-10 mb-md-14 align-items-center">
      ...
      <div className="col-lg-5">
        ...
        <p className="lead fs-lg">
          Let’s make something great together. We are trusted by over 5000+ clients. Join them by using our services and
          grow your business.
        </p>
