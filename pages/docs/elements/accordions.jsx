...
import { simpleMarkup, cardMarkup, shadowMarkup } from 'markups/elements/accordions'; // -------- data -------- //
...
const Accordions = () => {
  return <DocLayout pageTitle="Accordion" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-6 mx-auto" description={<>
          Use our custom accordion element to build vertically collapsing accordions.{' '}
          <a href="https://getbootstrap.com/docs/5.2/components/accordion/" target="_blank" className="hover more" rel="noreferrer">
            Bootstrap docs
          </a>
        </>}>
      {
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="accordion-wrapper" id="accordion">
              {accordions.map(item => <Accordion key={item.no} {...item} />)}
            </div>
          </div>
      ...
      <section id="snippet-3" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="accordion-wrapper" id="accordion">
              {accordions.map(item => <Accordion type="shadow-lg" key={item.no} {...item} />)}
            </div>
          </div>
