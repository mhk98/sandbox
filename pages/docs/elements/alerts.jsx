...
import { simpleMarkup, dismissalMarkup } from 'markups/elements/alerts'; // -------- data -------- //
...
const Alerts = () => {
  return <DocLayout pageTitle="Alerts" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-6 mx-auto" description={<>
          Use our custom alert styles to provide contextual feedback messages for typical user actions.{' '}
          <a href="https://getbootstrap.com/docs/5.2/components/alerts/" target="_blank" className="hover more" rel="noreferrer">
            Bootstrap docs
          </a>
        </>}>
      {
