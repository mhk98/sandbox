...
import { tinyMarkup, leadMarkup, listMarkup, quoteMarkup, linksMarkup, headingMarkup, displayMarkup, dropcapMarkup } from 'markups/elements/typography'; // -------- data -------- //
...
const Typography = () => {
  return <DocLayout pageTitle="Tooltips & Popovers" quickAccssLinks={quickAccess} descriptionClass="lead px-xxl-13" headingColClass="col-md-9 col-lg-7 col-xl-7 mx-auto" description={<>
          Use Bootstrap{' '}
          <a href="https://getbootstrap.com/docs/5.2/components/tooltips/" className="hover more" rel="noreferrer" target="_blank">
            Tooltips
          </a>{' '}
          and{' '}
          <a href="https://getbootstrap.com/docs/5.2/components/popovers/" className="hover more" rel="noreferrer" target="_blank">
            Popovers
          </a>{' '}
