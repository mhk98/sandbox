  ...
  return <Fragment>
      <form onSubmit={handleSubmit} className="text-start mb-3">
        <div className="form-floating mb-4">
          <input id="name" type="text" value={name} placeholder="Name" className="form-control" onChange={e => setName(e.target.value)} />
        ...
        <div className="form-floating password-field mb-4">
          <input id="password-confirm" value={confirmPassword} className="form-control" placeholder="Confirm Password" type={visiblePassword ? 'text' : 'password'} onChange={e => setConfirmPassword(e.target.value)} />
          <span className="password-toggle" onClick={() => setVisiblePassword(!visiblePassword)}>
            <i className={`uil  ${visiblePassword ? 'uil-eye-slash' : 'uil-eye'}`} />
          </span>
