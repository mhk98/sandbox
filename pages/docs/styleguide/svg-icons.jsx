...
import PartnerShip from 'icons/solid-mono/PartnerShip'; // -------- data -------- //
...
const duoColors = ['text-green-fuchsia', 'text-purple-aqua', 'text-blue-pink', 'text-navy-green', 'text-grape-green', 'text-green-red', 'text-grape-yellow', 'text-purple-pink', 'text-red-yellow', 'text-grape-fuchsia', 'text-sky-pink', 'text-navy-sky'];
const solidColors = ['bg-pale-primary', 'bg-pale-aqua', 'bg-pale-green', 'bg-pale-leaf', 'bg-pale-navy', 'bg-pale-orange', 'bg-pale-pink', 'bg-pale-purple', 'bg-pale-red', 'bg-pale-violet', 'bg-pale-yellow', 'bg-pale-blue', 'bg-pale-fuchsia', 'bg-pale-sky', 'bg-pale-grape', 'bg-pale-white'];

const SvgIcons = () => {
  const linealIcons = [Analytics, AwardTwo, BarChart, BriefcaseTwo, Browser, Check, ClockThree, CloudComputing, Design, Earth, Gift, Home, IdCard, LightBulb, List, Loading, Medal, Megaphone, PieChartTwo, Printer, Rocket, Savings, SearchTwo, Settings, SettingsThree, Shield, ShoppingBasket, ShopTwo, SmartphoneTwo, Target, Team, TeleMarketer, Telephone, User, ChatTwo, Search];
  const solidDuoIcons = [BarChartTwo, CloudGroup, CloudNetwork, Director, EmployeesTwo, Script, Server, Setting, TargetTwo];
  const solidMonoIcons = [Alarm, Building, Bulb, Compare, DeliveryBox, Edit, Employees, Headphone, Lamp, PartnerShip, PushCart, Puzzle, Share, Shipment, TeamTwo, Verify, VideoCall, VideoChat, Wallet];
  return <DocLayout pageTitle="SVG Icons" quickAccssLinks={quickAccess} description="Below you can find the list of all SVG icons included in Sandbox. Copy their codes easily with the copy buttons.">
      {
      /* ========== section 1 ========== */
    }
      <section id="snippet-1" className="wrapper pt-16">
        ...
        <p className="lead mb-8">
          ...
          <a href="https://www.flaticon.com/authors/monochrome/yellow" target="_blank" className="hover more" rel="noreferrer">
            Flaticon
          </a>
        </p>
        ...
        <div className="card mb-12">
          <div className="card-body">
            <div className="row gy-8 text-center">
              {Object.keys(color).sort().map(item => <div className="col-6 col-md-4 col-lg-3" key={item}>
                    <div>
        ...
        <div className="card mb-12">
          <div className="card-body">
            <div className="row gy-8 text-center d-flex align-items-end">
              {sizes.map(item => <div className="col-6 col-lg-3" key={item}>
                  <div>
        ...
        <ul className="glyphs glyphs-svg row row-cols-2 row-cols-md-4 row-cols-lg-5 gy-6">
          {linealIcons.sort().map((Icon, i) => <li className="col text-center" key={i}>
              <div className="card h-100">
                ...
                <div className="card-footer position-relative">
                  <a className="stretched-link link-body btn-copy-icon" data-clipboard-text={`<${Icon.name} className="icon-svg-sm text-primary" />`}>
                    Copy
                  </a>
                </div>
              </div>
      ...
      <section id="snippet-2" className="wrapper pt-16">
        ...
        <p className="lead mb-8">
          ...
          <a href="https://www.flaticon.com/authors/pixel-perfect/tritone" target="_blank" className="hover more" rel="noreferrer">
            Flaticon
          </a>
        </p>
        ...
        <ul className="glyphs glyphs-svg row row-cols-2 row-cols-md-4 row-cols-lg-5 gy-6">
          {solidMonoIcons.sort().map((Icon, i) => <li className="col text-center" key={i}>
              <div className="card h-100">
                <div className="card-body">
                ...
                <div className="card-footer position-relative">
                  <a className="stretched-link link-body btn-copy-icon" data-clipboard-text={`<${Icon.name} className="icon-svg-xs text-primary" />`}>
                    Copy
                  </a>
                </div>
              </div>
      ...
      <section id="snippet-3" className="wrapper pt-16">
        ...
        <div className="card mb-12">
          <div className="card-body">
            <div className="row gy-8 text-center">
              {duoColors.sort().map(item => <div className="col-6 col-md-4 col-lg-3" key={item}>
                  <div>
        ...
        <ul className="glyphs glyphs-svg row row-cols-2 row-cols-md-4 row-cols-lg-5 gy-6">
          {solidDuoIcons.sort().map((Icon, i) => <li className="col text-center" key={i}>
              <div className="card h-100">
                <div className="card-body">
                ...
                <div className="card-footer position-relative">
                  <a className="stretched-link link-body btn-copy-icon" data-clipboard-text={`<${Icon.name} className="icon-svg-xs text-navy-sky" />`}>
                    Copy
                  </a>
                </div>
              </div>
      ...
      <section id="snippet-4" className="wrapper py-16">
        ...
        <div className="card mb-12">
          <div className="card-body">
            <div className="row gy-8 text-center">
              {solidColors.map((item, id) => <div className="col-6 col-md-4 col-lg-3" key={id}>
                  <div>
