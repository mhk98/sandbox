import { TeamCard1 } from 'components/reuseable/team-cards'; // -------- data -------- //
      ...
      <div className="container py-14 pt-md-16 pb-md-18">
        <div className="position-relative mt-8 mt-lg-n23 mt-xl-n25">
          ...
          <div className="position-relative">
            <div className="shape bg-dot blue rellax w-16 h-17" style={{
            zIndex: 0,
            bottom: '0.5rem',
            right: '-1.7rem'
          }} />
            <div className="shape rounded-circle bg-line red rellax w-16 h-16" style={{
            zIndex: 0,
            top: '0.5rem',
            left: '-1.7rem'
          }} />
            ...
            <div className="row grid-view gy-6 gy-xl-0">
              {teams.slice(0, 4).map(item => <div className="col-md-6 col-xl-3" key={item.id}>
                  <TeamCard1 {...item} />
                </div>)}
            </div>
          </div>
