...
import { standardMarkup, dataDelayMarkup, groupWrapMarkup, parentWrapMarkup, dataDurationMarkup, dataIntervalMarkup } from 'markups/elements/animations'; // -------- data -------- //
...
const Animations = () => {
  return <DocLayout pageTitle="Animations" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-6 mx-auto" description={<>
