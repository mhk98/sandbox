const Hero31 = () => {
  return <section className="wrapper">
      <div className="container pt-11 pt-md-13 pb-19 pb-md-17 text-center">
        <div className="row">
          <div data-delay="500" data-cues="slideInDown" data-group="page-title" className="col-lg-9 col-xl-8 col-xxl-7 mx-auto">
        ...
        <div className="row">
          <div className="col-lg-10 col-xl-9 mx-auto mt-11 mb-n21">
            <figure>
              <img className="img-fluid" src="/img/illustrations/i28.png" srcSet="/img/illustrations/i28@2x.png 2x" alt="" />
            </figure>
          </div>
        </div>
      </div>
