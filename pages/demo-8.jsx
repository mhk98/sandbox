...
const Demo8 = () => {
  ...
  return <Fragment>
      ...
      <header className="wrapper bg-light pt-1">
        <Navbar search navOtherClass="navbar-other ms-lg-4" navClassName="navbar navbar-expand-lg classic transparent navbar-light" button={<a href="#" data-bs-toggle="modal" data-bs-target="#modal-signin" className="btn btn-sm btn-primary rounded-pill">
              Sign In
            </a>} />
      </header>
