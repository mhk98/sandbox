import { slideInDownAnimate } from 'utils/animation'; // -------- custom component -------- //
...
const Hero11 = () => {
  // use video popup
  useLightBox();
  return <section className="wrapper image-wrapper bg-image bg-overlay bg-overlay-400 bg-content text-white" style={{
          ...
          <div className="col-lg-5 offset-lg-1">
            <div className="swiper-container dots-over shadow-lg">
              <Carousel slidesPerView={1}>
                ...
                <div>
                  <a data-glightbox data-gallery="hero" href="/media/movie.mp4" className="btn btn-circle btn-white btn-play ripple mx-auto mb-5 position-absolute" style={{
                  top: '50%',
                  left: '50%',
                  ...
                  <img alt="" className="rounded" src="/img/photos/about22.jpg" srcSet="/img/photos/about22@2x.jpg 2x" />
                </div>
