...
import { iconMarkup, playMarkup, sizesMarkup, colorsMarkup, shapesMarkup, stylesMarkup, circleMarkup, socialMarkup, expandMarkup, gradientsMarkup } from 'markups/elements/buttons'; // -------- data -------- //
...
const Buttons = () => {
  return <DocLayout pageTitle="Buttons" quickAccssLinks={quickAccess} description={<>
          Use our custom button styles for actions in forms, dialogs, with support for multiple sizes, states, etc.{' '}
          <a href="https://getbootstrap.com/docs/5.2/components/buttons/" target="_blank" className="hover more" rel="noreferrer">
            Bootstrap docs
          </a>
        </>}>
      {
      ...
      <section id="snippet-2" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            ...
            <br className="d-none d-lg-block" />
            <NextLink href="#" title={<span>Button</span>} className="btn btn-outline-gradient gradient-1 rounded-pill mb-2 me-1" />
            <NextLink href="#" title={<span>Button</span>} className="btn btn-outline-gradient gradient-2 rounded-pill mb-2 me-1" />
            <NextLink href="#" title={<span>Button</span>} className="btn btn-outline-gradient gradient-3 rounded-pill mb-2 me-1" />
            <NextLink href="#" title={<span>Button</span>} className="btn btn-outline-gradient gradient-4 rounded-pill mb-2 me-1" />
            <NextLink href="#" title={<span>Button</span>} className="btn btn-outline-gradient gradient-5 rounded-pill mb-2 me-1" />
            <NextLink href="#" title={<span>Button</span>} className="btn btn-outline-gradient gradient-6 rounded-pill mb-2 me-1" />
            <NextLink href="#" title={<span>Button</span>} className="btn btn-outline-gradient gradient-7 rounded-pill mb-2 me-1" />
          </div>
      ...
      <section id="snippet-5" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            ...
            <NextLink href="#" title="Gradient" className="btn btn-gradient gradient-1 rounded-pill me-1 mb-2 mb-md-0" />

            <NextLink href="#" title={<span>Outline Gradient</span>} className="btn btn-outline-gradient gradient-1 rounded-pill me-1 mb-2 mb-md-0" />
          </div>
      ...
      <section id="snippet-6" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body">
            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-primary btn-lg me-2 mb-2" />

            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-primary me-2 mb-2" />
            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-primary btn-sm me-2 mb-2" />
            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-soft-primary btn-lg me-2 mb-2" />

            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-soft-primary me-2 mb-2" />

            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-soft-primary btn-sm me-2 mb-2" />

            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-outline-primary btn-lg me-2 mb-2" />

            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-outline-primary me-2 mb-2" />

            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-outline-primary btn-sm me-2 mb-2" />

            <br className="d-none d-lg-block" />

            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-gradient gradient-1 btn-lg me-2 mb-2" />

            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-gradient gradient-1 me-2 mb-2" />

            <NextLink href="#" title={<i className="uil uil-check" />} className="btn btn-circle btn-gradient gradient-1 btn-sm me-2 mb-2" />

            <NextLink href="#" className="btn btn-circle btn-outline-gradient gradient-1 btn-lg me-2 mb-2" title={<span>
                  <i className="uil uil-check" />
                </span>} />

            <NextLink href="#" className="btn btn-circle btn-outline-gradient gradient-1 me-2 mb-2" title={<span>
                  <i className="uil uil-check" />
                </span>} />
            <NextLink href="#" className="btn btn-circle btn-outline-gradient gradient-1 btn-sm me-2 mb-2" title={<span>
                  <i className="uil uil-check" />
                </span>} />
          </div>
