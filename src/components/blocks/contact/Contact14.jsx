const Contact14 = () => {
  return <section className="wrapper bg-gradient-blend">
      <div className="container pt-15 pt-md-17 pb-13 pb-md-15">
        <div className="row gx-md-8 gx-xl-12 gy-10">
          <div className="col-lg-6">
            <img src="./assets/img/icons/solid/email-2.svg" className="svg-inject icon-svg icon-svg-sm solid-duo text-purple-aqua mb-3" alt="" />
              ...
              <div className="row gx-4">
                <div className="col-md-6">
                  <div className="form-floating mb-4">
                    <input id="form_name" type="text" name="name" className="form-control border-0" placeholder="Jane" required data-error="First Name is required." />
                ...
                <div className="col-md-6">
                  <div className="form-floating mb-4">
                    <input id="form_email" type="email" name="email" className="form-control border-0" placeholder="jane.doe@example.com" required data-error="Valid email is required." />
                ...
                <div className="col-12">
                  <div className="form-floating mb-4">
                    <textarea id="form_message" name="message" className="form-control border-0 h-20" placeholder="Your message" required />
