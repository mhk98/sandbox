...
const ThemeSetup = () => {
  return <DocLayout pageTitle="Theme" quickAccssLinks={quickAccess} description="Set defalut colors and fonts using build time or runtime theming">
      {
      /* ========== section 1 ========== */
    }
