  ...
  return <Fragment>
      ...
      <div className="row gy-10 align-items-center mb-15 mb-md-17">
        <div className="col-lg-7">
          <figure>
            <img className="img-fluid" src="/img/illustrations/i29.png" srcSet="/img/illustrations/i29@2x.png 2x" alt="" />
          </figure>
        </div>
      ...
      <div className="row gy-10 align-items-center mb-15 mb-md-17">
        <div className="col-lg-7 order-lg-2">
          <figure>
            <img className="img-fluid" src="/img/illustrations/i30.png" srcSet="/img/illustrations/i30@2x.png 2x" alt="" />
          </figure>
        </div>
      ...
      <div className="row gy-10 align-items-center">
        <div className="col-lg-7">
          <figure>
            <img className="img-fluid" src="/img/illustrations/i31.png" srcSet="/img/illustrations/i31@2x.png 2x" alt="" />
          </figure>
        </div>
