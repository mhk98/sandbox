const ShoppingBasket = ({
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 412.9" className={`svg-inject icon-svg ${className || 'icon-svg-md text-primary mb-3'}`}>
