...
const ProductCard = props => {
  ...
  return <div className={`project item ${className}`}>
      <figure className="rounded mb-6 position-relative overflow-hidden">
        ...
        <a href="#" title="" className="item-like" aria-label="Add to wishlist" data-bs-toggle="white-tooltip" data-bs-original-title="Add to wishlist">
          <i className="uil uil-heart" />
        </a>

        <a href="#" title="" className="item-view" aria-label="Quick view" data-bs-toggle="white-tooltip" data-bs-original-title="Quick view">
