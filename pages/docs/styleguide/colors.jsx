...
import { textColorMarkup, bgColorMarkup } from 'markups/styleguide/colors'; // -------- data -------- //

const quickAccess = [{
  title: 'Changing Primary',
  url: 'snippet-2'
}, {
...
const Color = () => {
  return <DocLayout pageTitle="Color" quickAccssLinks={quickAccess} description="Use our custom color options to add color to your backgrounds, text or to change the color scheme.">
      {
      /* ========== section 2 ========== */
    }
