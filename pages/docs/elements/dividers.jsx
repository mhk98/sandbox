...
import { borderMarkup, anglesMarkup, wavesMarkup } from 'markups/elements/dividers'; // -------- data -------- //
...
const Dividers = () => {
  return <DocLayout pageTitle="Card" quickAccssLinks={quickAccess} description={<>
          ...
          <a href="https://getbootstrap.com/docs/5.2/components/card/" target="_blank" className="hover more" rel="noreferrer">
            Bootstrap docs
          </a>
        </>}>
      {
        ...
        <div className="card">
          <div className="card-body">
            <figure className="position-relative mb-10">
              ...
              <span className="display-6 text-navy" style={{
              position: 'absolute',
              left: '50%',
              top: '50%',
