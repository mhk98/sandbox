...
import useReplaceMe from 'hooks/useReplaceMe'; // -------- markups -------- //

import { typerMarkup, replaceMeMarkup } from 'markups/elements/text-animation'; // -------- data -------- //
...
const TextAnimations = () => {
  ...
  useReplaceMe();
  return <DocLayout pageTitle="Text Animations" quickAccssLinks={quickAccess} descriptionClass="lead" description={<>
