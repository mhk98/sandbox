...
import { ServiceCard6 } from 'components/reuseable/service-cards'; // -------- data -------- //
...
const Services14 = () => {
  return <Fragment>
      ...
      <div className="position-relative mb-14 mb-md-17">
        <div className="shape rounded-circle bg-soft-primary rellax w-16 h-16" style={{
        bottom: '-0.5rem',
        right: '-2.5rem',
        zIndex: 0
      }} />
        ...
        <div className="row gx-md-5 gy-5 text-center">
          {serviceList2.map(item => <ServiceCard6 key={item.id} {...item} />)}
        </div>
      </div>
    </Fragment>;
};
