...
const v11 = ['pages/demo-26.tsx', 'pages/demo-27.tsx', '', 'src/components/blocks/about/About27.tsx', 'src/components/blocks/about/About28.tsx', 'src/components/blocks/blog/Blog7.tsx', 'src/components/blocks/call-to-action/CTA10.tsx', 'src/components/blocks/contact/Contact13.tsx', 'src/components/blocks/facts/Facts17.tsx', 'src/components/blocks/faq/FAQ7.tsx', 'src/components/blocks/footer/Footer17.tsx', 'src/components/blocks/footer/Footer18.tsx', 'src/components/blocks/hero/Hero26.tsx', 'src/components/blocks/hero/Hero27.tsx', 'src/components/blocks/pricing/Pricing9.tsx', 'src/components/blocks/pricing/Pricing10.tsx', 'src/components/blocks/process/Process16.tsx', 'src/components/blocks/process/Process17.tsx', 'src/components/blocks/services/Services28.tsx', 'src/components/blocks/services/Services29.tsx', 'src/components/blocks/testimonial/Testimonial20.tsx', 'src/components/blocks/testimonial/Testimonial21.tsx', '', 'src/data/demo-26.ts', 'src/data/demo-27.ts'];

const Changelog = () => {
  return <DocLayout pageTitle="Changelog" description="Find out what is newly added, changed, fixed, improved or updated in the latest Sandbox versions.">
          ...
          <div className="card-body">
            <ul className="list-unstyled mb-0">
              <li className="d-flex flex-row mb-2">
                ...
                <p className="mb-0">
                  7 new demos:{' '}
                  {[28, 29, 30, 31, 32, 33, 34].map(item => <a href={`/demo-${item}`} className="external mt-n1" target="_blank" key={item}>
                      Demo {item}
                    </a>)}
                </p>
              </li>
              ...
              <li className="d-flex flex-row mb-2">
                ...
                <p className="mb-0">
                  ...
                  {[28, 29, 30].map(item => <a href={`/demo-${item}`} className="external mt-n1" target="_blank" key={item}>
                      Demo {item}
                    </a>)}
                </p>
              </li>
