...
const Process3 = () => {
  return <div className="row gy-10 gy-sm-13 gx-lg-3 mb-16 mb-md-18 align-items-center">
      ...
      <div className="col-lg-5 col-xl-4 offset-lg-1">
        ...
        {processList4.map(item => <ProcessList2 {...item} key={item.no} className="icon btn btn-block btn-soft-primary pe-none me-5" />)}
      </div>
    </div>;
};
