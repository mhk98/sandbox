  ...
  return <Fragment>
      <div className="row text-center">
        <div className="col-md-10 col-lg-7 mx-auto position-relative">
          <img data-delay="1800" src="/img/svg/doodle5.svg" className="w-15 position-absolute d-none d-lg-block" style={{
          bottom: '-60%',
          right: '10%'
        }} alt="" />

          <img data-delay="1800" src="/img/svg/doodle6.svg" className="h-15 position-absolute d-none d-lg-block" style={{
          top: '-40%',
          left: '-5%'
        }} alt="" />
