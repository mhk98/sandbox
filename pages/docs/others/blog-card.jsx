...
import { BlogCard1, BlogCard2, BlogCard3, BlogCard4, BlogCard5 } from 'components/reuseable/blog-cards'; // -------- markups -------- //
...
const BlogCards = () => {
  return <DocLayout pageTitle="Blog Cards" quickAccssLinks={quickAccess} headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Use our custom blog card components to build any custom blog section or blocks">
      {
      /* ========== section 1 ========== */
    }
      ...
      <section id="snippet-2" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <BlogCard2 link="#" category="Restaurants" title="Fringilla Ligula Pharetra Amet" description="Duis mollis, est non commodo luctus, nisi erat porttitor ligula" cardTop={<figure className="card-img-top overlay overlay-1 hover-scale">
      ...
      <section id="snippet-4" className="wrapper pt-16">
        ...
        <div className="card">
          <div className="card-body mb-n2">
            <div className="row gy-6">
              {blogList.slice(0, 2).map(item => <div className="col-lg-6" key={item.id}>
                  <BlogCard4 {...item} />
                </div>)}
            </div>
          </div>
