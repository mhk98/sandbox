...
import { underlineMarkup, underlineThreeMarkup, underlineTwoMarkup } from 'markups/elements/text-highlight'; // -------- data -------- //
...
const TextHighlight = () => {
  return <DocLayout pageTitle="Text Highlight" quickAccssLinks={quickAccess} descriptionClass="lead px-xxl-10" headingColClass="col-md-9 col-lg-7 col-xl-5 mx-auto" description="Use our custom text highlight styles to mark important text on your website.">
      {
      /* ========== section 1 ========== */
    }
