...
import { dotMarkup, lineMarkup, solidMarkup } from 'markups/elements/shapes'; // -------- data -------- //
...
const Shapes = () => {
  return <DocLayout pageTitle="Shapes" quickAccssLinks={quickAccess} description="Use our custom shapes to add on your pages.">
      {
      /* ========== section 1 ========== */
    }
