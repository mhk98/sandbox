...
const FAQ = () => {
  ...
  useClipboard();
  return <DocLayout pageTitle="FAQ" description="Find answers to some frequently asked questions here.">
      {
      /* ========== section 1 ========== */
    }
      <section id="snippet-1" className="wrapper py-16">
        ...
        <a href="https://support.ui-lib.com" className="btn btn-primary rounded-pill me-2" target="_blank" rel="noreferrer">
          Contact Form
        </a>

        <a href="https://themeforest.net/item/sandbox-modern-multipurpose-react-template/40486293/comments" className="btn btn-soft-primary rounded-pill" target="_blank" rel="noreferrer">
          Discussions Page
        </a>
        ...
        <div className="accordion accordion-wrapper mt-10" id="accordion">
          <div className="card accordion-item">
            <div className="card-header" id="faq-2">
              <button className="collapsed" data-bs-toggle="collapse" data-bs-target="#faq-collapse-2" aria-expanded="false" aria-controls="faq-collapse-2">
          ...
          <div className="card accordion-item">
            <div className="card-header" id="faq-6">
              <button className="collapsed" data-bs-toggle="collapse" data-bs-target="#faq-collapse-6" aria-expanded="false" aria-controls="faq-collapse-6">
          ...
          <div className="card accordion-item">
            <div className="card-header" id="faq-3">
              <button className="collapsed" data-bs-toggle="collapse" data-bs-target="#faq-collapse-3" aria-expanded="false" aria-controls="faq-collapse-3">
            ...
            <div id="faq-collapse-3" className="accordion-collapse collapse" aria-labelledby="faq-3">
              <div className="card-body">
                <p>
                  ...
                  <a href="https://rtlcss.com/learn/usage-guide/install/" target="_blank" className="external" rel="noreferrer">
                    RTLCSS
                  </a>{' '}
          ...
          <div className="card accordion-item">
            <div className="card-header" id="faq-8">
              <button className="collapsed" data-bs-toggle="collapse" data-bs-target="#faq-collapse-8" aria-expanded="false" aria-controls="faq-collapse-8">
          ...
          <div className="card accordion-item">
            <div className="card-header" id="faq-9">
              <button className="collapsed" data-bs-toggle="collapse" data-bs-target="#faq-collapse-9" aria-expanded="false" aria-controls="faq-collapse-9">
          ...
          <div className="card accordion-item">
            <div className="card-header" id="faq-11">
              <button className="collapsed" data-bs-toggle="collapse" data-bs-target="#faq-collapse-11" aria-expanded="true" aria-controls="faq-collapse-11">
    ...
    <ul className="dropdown-menu mega-menu"> ... </ul>
          ...
          <div className="card accordion-item">
            <div className="card-header" id="faq-12">
              <button className="collapsed" data-bs-toggle="collapse" data-bs-target="#faq-collapse-12" aria-expanded="true" aria-controls="faq-collapse-12">
                {' '}
            ...
            <div id="faq-collapse-12" className="accordion-collapse collapse" aria-labelledby="faq-12">
              <div className="card-body">
                <p>
                  ...
                  <a className="external my-0" href="https://fonts.google.com/specimen/Manrope" target="_blank" rel="noreferrer">
                    Manrope
                  </a>
                </p>
              </div>
