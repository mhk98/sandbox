...
const Demo6 = () => {
  ...
  return <Fragment>
      ...
      <header className="wrapper bg-soft-primary">
        <Navbar navOtherClass="navbar-other ms-lg-4" navClassName="navbar navbar-expand-lg classic transparent navbar-light" button={<NextLink title="Free Trial" href="#" className="btn btn-sm btn-primary rounded" />} />
      </header>
            ...
            <div className="row">
              <div className="col-xl-10 mx-auto">
                <div className="mt-lg-n20 mt-xl-n22 mb-14 mb-md-16 position-relative">
                  <a data-glightbox href="/media/movie.mp4" className="btn btn-circle btn-primary btn-play ripple mx-auto mb-5 position-absolute" style={{
                  top: '50%',
                  left: '50%',
